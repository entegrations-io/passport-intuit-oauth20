...
please post a question on the [discussion forum](https://github.com/entegrations-io/passport-intuit-oauth20/discuss)
...
* passport-intuit-oauth20 version: <!-- $ npm list passport-intuit-oauth20 -->
